    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.SmallIntegerField(validators=[reviews.validators.year_validator], verbose_name='Год выхода')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(choices=[(1, 'Полный провал'), (2, 'Ужасно'), (3, 'Плохо'), (4, 'Ниже среднего'), (5, 'На один раз'), (6, 'Выше среднего'), (7, 'Очень хорошо'), (8, 'Отлично'), (9, 'Потрясающе'), (10, 'Восторг')], validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)], verbose_name='Оценка')),
